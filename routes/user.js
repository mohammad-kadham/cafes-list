...
router.post("/rate", routeAuth.auth, [
    ...
    body("wifi").isInt({ min: 1, max: 3 }).withMessage("wifi rating must be between 1 and 5"),
    body("outlet").isInt({ min: 1, max: 3 }).withMessage("outlet rating must be between 1 and 5"),
    body("seat").isInt({ min: 1, max: 3 }).withMessage("seat rating must be between 1 and 5"),
    body("service").isInt({ min: 1, max: 3 }).withMessage("service rating must be between 1 and 5"),
    body("noise").isInt({ min: 1, max: 3 }).withMessage("noise rating must be between 1 and 5"),
    body("price").isInt({ min: 1, max: 3 }).withMessage("price rating must be between 1 and 5"),
